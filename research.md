...
Our current work is framed in the context of a revolution in our understanding of speciation that has emerged in the genomic age and that is not yet near complete. Just prior to the routine publication of whole genomes, for instance, Coyne and Orr (2004) exhaustively surveyed the speciation literature and concluded "our guess is that morphologically distinct taxa showing rampant gene exchange at many loci will be rare" (p.41). We now know that such data are commonplace, that strong organismal RI doesn't always translate into reduced gene flow &mdash; and, most radically (in the context of Modern Synthesis thought), that stable co-occurrence between diagnosable taxa does not imply a lack of introgression. Species that look obviously distinct, even when in contact, are not necessarily evolving independently. 

A key priority in our current age is thus to develop research questions that (1) treat RI as continuous rather than discrete, (2) recognize the reversibility of the proecess, and (3) are, rather paradoxically, agnostic about species status. One question that meets these criteria also forms the unifying theme of our current work: ***how and why does the extent of independent evolution across the genomes of two lineages rise or fall over time?***
